						...
						data.tracks.items.map((track, i) => {
							...
							return (
								<div
									...
									className={cn(
										"grid grid-cols-[2rem_1fr_auto] sm:grid-cols-[2rem_1fr_auto_2.75rem] items-center px-0 py-2.5 rounded-md transition-colors group cursor-pointer select-none",
